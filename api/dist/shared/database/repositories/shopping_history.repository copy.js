...
exports.ShoppingHistoryRepository = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma.service");
let ShoppingHistoryRepository = class ShoppingHistoryRepository {
    ...
    deleteMany(deleteManyDto) {
        return this.prismaService.shoppingHistory.deleteMany(deleteManyDto);
    }
};
exports.ShoppingHistoryRepository = ShoppingHistoryRepository;
exports.ShoppingHistoryRepository = ShoppingHistoryRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], ShoppingHistoryRepository);
//# sourceMappingURL=shopping_history.repository%20copy.js.map